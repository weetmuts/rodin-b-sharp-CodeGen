...
public class CSubroutineTranslator_Open_MP extends AbstractSubroutineIL1Translator {
	...
	protected ArrayList<String> generateFunction(String name,
			...
			ArrayList<String> body, boolean isProtected, boolean isEnviron, String machineName, Subroutine actualSource, IL1TranslationManager translationManager) {
