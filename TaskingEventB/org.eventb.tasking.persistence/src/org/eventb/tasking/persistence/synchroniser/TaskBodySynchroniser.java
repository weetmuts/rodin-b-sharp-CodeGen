...
public class TaskBodySynchroniser extends AbstractSynchroniser {
			...
			IProgressMonitor monitor) throws CoreException 
	{
		if (rodinElement instanceof ITaskBody && emfParent instanceof TaskImpl)
		{
			...
			try {
				...
				CompositeControl generated = convertRodinToEMF((Task)emfParent, taskBody);
	 ...
	 */
	private CompositeControl convertRodinToEMF(Task emfParent, String taskBody) throws UnsupportedEncodingException, RodinDBException, ParseException
	{
		//	Use Renato's TextToEMFParser to do this
		TextToEMFParser parser = new TextToEMFParser(taskBody, emfParent);
