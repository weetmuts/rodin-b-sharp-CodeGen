...
public class TranslatorUtils {
	...
	public static Formula<?> parseEventBFormula(IFormulaElement element,
		...
		IParseResult result = ff.parseAssignment(formStr, V2, null);
...
//		IAttributeType.String attributeType = EventBTheoryTranslatorAttributes.FORMULA_ATTRIBUTE;
		...
		IParseResult result = ff.parseExpressionPattern(form, V2, null);
		if(result.hasProblem()){
			result = ff.parsePredicatePattern(form, V2, null);
