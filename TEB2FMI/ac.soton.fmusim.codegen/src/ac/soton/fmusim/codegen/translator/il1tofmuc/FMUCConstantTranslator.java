...
public class FMUCConstantTranslator extends AbstractConstantIL1Translator {
	...
	protected String generateConstantDeclaration(String type,
		...
		{
			return "#define " + identifier + " " + initialisation;			
		}
		else
		{
			try {
				...
				System.out.println("no initialisation found");
				e.printStackTrace();
			}
		}
		return "";
