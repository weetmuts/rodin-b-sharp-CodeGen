 ...
 * <ul>
 *   <li>{@link FmiModelV1.impl.ModelVariablesTypeImpl#getGroup <em>Group</em>}</li>
 *   <li>{@link FmiModelV1.impl.ModelVariablesTypeImpl#getScalarVariable <em>Scalar Variable</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelVariablesTypeImpl extends EObjectImpl implements ModelVariablesType {
	...
	protected EClass eStaticClass() {
		return FmiModelV1Package.Literals.MODEL_VARIABLES_TYPE;
	}
	...
	public FeatureMap getGroup() {
		if (group == null) {
			group = new BasicFeatureMap(this, FmiModelV1Package.MODEL_VARIABLES_TYPE__GROUP);
		}
		return group;
	}
	...
	public EList<FmiScalarVariable> getScalarVariable() {
		return getGroup().list(FmiModelV1Package.Literals.MODEL_VARIABLES_TYPE__SCALAR_VARIABLE);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case FmiModelV1Package.MODEL_VARIABLES_TYPE__GROUP:
				return ((InternalEList<?>)getGroup()).basicRemove(otherEnd, msgs);
			case FmiModelV1Package.MODEL_VARIABLES_TYPE__SCALAR_VARIABLE:
